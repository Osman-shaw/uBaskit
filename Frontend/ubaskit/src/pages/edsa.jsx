...
const sierraLeoneLocations = [
  { region: 'Western Area', districts: ['Freetown', 'Western Area Rural'] },
  { region: 'Northern Province', districts: ['Bombali', 'Kambia', 'Koinadugu', 'Port Loko', 'Tonkolili'] },
  { region: 'Eastern Province', districts: ['Kailahun', 'Kenema', 'Kono'] },
  { region: 'Southern Province', districts: ['Bo', 'Bonthe', 'Moyamba', 'Pujehun'] },
  { region: 'North West Province', districts: ['Karene', 'Falaba'] },
];

export default function Electricity({ onTransactionAdd }) {
  ...
  const validateCustomerInfo = () => {
    const newErrors = {};
    if (!formData.meterNumber.match(/^\d{2}-\d{3}-\d{3}-\d{3}$|^\d{11}$/)) {
      newErrors.meterNumber = 'Enter a valid 11-digit EDSA meter number (e.g., 01-234-567-890)';
    }
      ...
      <section className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
        <header className="py-8 sm:py-10 text-center space-y-3 md:max-w-3xl md:mx-auto">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold text-slate-900">
            Purchase Electricity with uBaskit
          </h1>
          <p className="text-slate-600 text-base sm:text-lg">
            Easily pay your electricity bills with a seamless, secure process.
          </p>
        </header>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  />
                  {errors.meterNumber && <p className="text-red-500 text-xs mt-1">{errors.meterNumber}</p>}
                </div>
                <div>
                ...
                <div>
                  ...
                  >
                    ...
                    {sierraLeoneLocations.map((region) =>
                      region.districts.map((district) => (
                        <option key={district} value={`${region.region} - ${district}`}>
            ...
            <div className="space-y-4">
              ...
              <div className="border border-gray-200 rounded-lg p-4 sm:p-6">
                ...
                <div className="mt-4 space-y-2 text-sm sm:text-base text-slate-600">
                  ...
                  <p><strong>Meter Number:</strong> {receipt.meterNumber}</p>
                  ...
                  <p><strong>Token:</strong> {receipt.token}</p>
